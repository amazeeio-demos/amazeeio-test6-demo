Docker Compose Drupal seed - php8, nginx, mariadb
=================================================
...
docker run --rm --net drupal-seed-test6_default amazeeio/dockerize dockerize -wait tcp://mariadb:3306 -timeout 1m
```
...
docker ps --filter label=com.docker.compose.project=drupal-seed-test6 | grep Up | grep drupal-seed-test6-nginx-1
docker ps --filter label=com.docker.compose.project=drupal-seed-test6 | grep Up | grep drupal-seed-test6-mariadb-1
docker ps --filter label=com.docker.compose.project=drupal-seed-test6 | grep Up | grep drupal-seed-test6-php-1
docker ps --filter label=com.docker.compose.project=drupal-seed-test6 | grep Up | grep drupal-seed-test6-cli-1

# Should ssh against the cli container by default
docker compose exec -T cli bash -c "env | grep LAGOON=" | grep cli-drupal

# Should have the correct environment set
docker compose exec -T cli bash -c "env" | grep LAGOON_ROUTE | grep drupal-seed-test6.docker.amazee.io
